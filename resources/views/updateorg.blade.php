...
<body>
    <div class="container">
        ...
        <div class="formstudent" style="margin-left: 28px; margin-right: 37px">
            ...
            <input type="text" class="form-control mt-3 mb-3" placeholder="Input username"> -->
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input name="lokasiPerusahaan" type="text" class="form-control" id="email"
                        placeholder="Enter email">
                </div>
                <div class="mb-3 mt-3">
                    <label for="email" class="form-label">Email:</label>
                    <input name="emailPerusahan" type="email" class="form-control" id="email"
                        placeholder="Enter email">
                </div>
                <div class="mb-3">
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
            <div class="button1">
                <button type="submit" class="btn btn-success" style="border-radius: 12px; background-color: #023880; width: 200px;
        height: 35px; font-family: 'Open Sans'; font-size: 18px;">
                    <p style="margin-top: 5px;">Save</p>
                </button>
            </div>
            <div class="button1">
                <button type="submit" class="btn btn-success" style="border-radius: 12px; background-color: #C7100F; width: 200px;
        height: 35px; font-family: 'Open Sans'; font-size: 18px;">
